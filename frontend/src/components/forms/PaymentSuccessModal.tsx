  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 text-slate-400">Invoice #{sale.id.toString().padStart(5, '0')}</p>
        ...
        <div className="space-y-3 text-left text-sm">
          ...
          <div className="flex justify-between"><span className="text-slate-400">Payment Method</span><strong>Cash</strong></div>
          <div className="flex justify-between border-t border-slate-100 pt-4 text-base"><strong>Amount Paid</strong><strong>{money(sale.total)}</strong></div>
        </div>
      </div>
    </Modal>
  )

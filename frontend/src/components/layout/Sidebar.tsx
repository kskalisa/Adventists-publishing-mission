...
import { customerNavItems } from "../../data/navigation";
              ...
              {items
                ...
                .map((item) => {
                  ...
                  const selected =
                    ...
                    (active === "inventory-manager-profile" &&
                      item.id === "inventory-manager-report");
